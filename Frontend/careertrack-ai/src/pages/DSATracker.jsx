...
function DSATracker() {
  ...
  const handleToggleStatus = (id) => {
    ...
    const token = localStorage.getItem("token");
    fetch(`http://localhost:8080/api/problems/${id}/status`, {
      method: "PATCH",
      headers: { 
...
//           <div>
//             {/* Added Dynamic Topic Title Here */}
//             <div style={{ marginBottom: "20px" }}>
//               <h1 style={{ fontSize: "24px", fontWeight: "700", color: "#FFFFFF", letterSpacing: "0.5px", margin: "0 0 4px 0" }}>
//                 {activeTopic}
//               </h1>
//               <p style={{ fontSize: "14px", color: "#9CA3AF", margin: 0 }}>Master these problems to level up.</p>
//             </div>
...
//       {/* Added minHeight and alignContent here to prevent container collapse on the Solved tab */}
//       <div style={{ display: "flex", flexWrap: "wrap", gap: "12px", backgroundColor: "#161622", border: "1px solid #2E2E42", borderRadius: "16px", padding: "28px", minHeight: "300px", alignContent: "flex-start" }}>
//         {topicsData.map((topic) => (
//           <button
//             key={topic.name}
//             onClick={() => setActiveTopic(topic.name)}
...
//             <span>{topic.name}</span>
//             <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
//               <span style={{ backgroundColor: "#2E2E42", color: "#9CA3AF", fontSize: "11px", padding: "2px 6px", borderRadius: "6px" }}>{topic.count}</span>
//               <span style={{ fontSize: "11px", color: topic.percentage > 0 ? "#34D399" : "#6B7280", fontWeight: "600" }}>{topic.percentage}%</span>
//             </div>
//           </button>
//         ))}
//       </div>
...
//     // Updated radii for better spacing
//     const rEasy = 52, rMed = 40, rHard = 28;
//     const circEasy = 2 * Math.PI * rEasy;
//     const circMed = 2 * Math.PI * rMed;
//     const circHard = 2 * Math.PI * rHard;
...
//             <div style={{ position: "relative", width: "120px", height: "120px", marginBottom: "28px" }}>
//               <svg width="120" height="120" style={{ transform: "rotate(-90deg)" }}>
//                 <circle cx="60" cy="60" r={rEasy} stroke="#1E1E2F" strokeWidth="4" fill="none" />
//                 <circle cx="60" cy="60" r={rEasy} stroke="#14b8a6" strokeWidth="4" strokeDasharray={circEasy} strokeDashoffset={offsetEasy} strokeLinecap="round" fill="none" />
//                 <circle cx="60" cy="60" r={rMed} stroke="#1E1E2F" strokeWidth="4" fill="none" />
//                 <circle cx="60" cy="60" r={rMed} stroke="#d97706" strokeWidth="4" strokeDasharray={circMed} strokeDashoffset={offsetMed} strokeLinecap="round" fill="none" />
//                 <circle cx="60" cy="60" r={rHard} stroke="#1E1E2F" strokeWidth="4" fill="none" />
//                 <circle cx="60" cy="60" r={rHard} stroke="#dc2626" strokeWidth="4" strokeDasharray={circHard} strokeDashoffset={offsetHard} strokeLinecap="round" fill="none" />
//               </svg>
//               <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", paddingTop: "4px" }}>
//                 <span style={{ fontSize: "20px", fontWeight: "700", color: "#FFFFFF", lineHeight: 1 }}>
//                   {solvedCount}<span style={{ fontSize: "14px", fontWeight: "500", color: "#9CA3AF" }}>/{totalTopicCount}</span>
//                 </span>
//                 <span style={{ fontSize: "13px", color: "#E5E7EB", marginTop: "4px", fontWeight: "500" }}>Solved</span>
//               </div>
//             </div>
