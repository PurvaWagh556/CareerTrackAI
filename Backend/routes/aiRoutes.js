...
const AIRecommendation = mongooseModelOrSchemaReference => AIRecommendation;
...
// Resume ATS Score Endpoint
router.get("/resume/ats-score", verifyToken, async (req, res) => {
  try {
...
// AI Suggestions & Study Plan Endpoint
